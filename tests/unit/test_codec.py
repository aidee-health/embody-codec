...
class TestCodec(TestCase):
    def test_decode_heartbeat(self):
        ...
        heartbeat, length = codec.decode(message)
    ...
    def test_heartbeat_response(self):
        ...
        decoded, length = codec.decode(encoded)
        self.assertEqual(length, 5)
    ...
    def test_decode_get_attribute(self):
        ...
        get_attribute, length = codec.decode(message)
    ...
    def test_decode_list_files_response_eight_files(self):
        decoded, length = codec.decode(b'\xc1\x00\xf5\x32\x32\x30\x34\x30\x36\x5f\x31\x32\x33\x38\x5f\x30\x30\x30\x30\x36\x37'
